from Graph_Coloring.graph_coloring import Graph_Coloring
...
pop_sizes = [40] * TOTAL_CASES
num_offsprings = [20] * TOTAL_CASES
num_iterations = [10] * TOTAL_CASES
num_gens = [500] * TOTAL_CASES
mutation_rates = [0.4] * TOTAL_CASES

optimization_TSP_ASF = list_of_problems(problem=problem,
                                        pop_sizes=pop_sizes,
                                        num_offsprings=num_offsprings,
                                        num_iterations=num_iterations,
                                        num_gens=num_gens,
