...
int main() {
        ...
        for (int i = 0; i < 5; i++) std::cout << dist[i].feet << "'" << dist[i].inches << "\"\n";
        ...
        for (int i = 0; i < 5; i++) std::cout << dist1[i].feet << "'" << dist1[i].inches << "\"\n";
        std::cout << std::endl;
        ...
        for (int i = 0; i < 5; i++) std::cout << dist2[i].feet << "'" << dist2[i].inches << "\"\n";
