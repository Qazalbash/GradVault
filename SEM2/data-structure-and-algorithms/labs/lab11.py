...
addEdges(G, [(0,1,1),(0,2,1),(1,2,1),(1,3,1),(2,4,1),(3,4,1),(3,5,1),(4,5,1)], True)
...
print(check_cycles(rosen, ['Austin','Houston','Atlanta','Washington','Dallas']))
...
addEdges(bfsG, [(0,1,1),(1,3,1),(1,4,1),(1,5,1),(0,2,1),(2,6,1),(6,7,1)])
