def binary_search(lst, item):
    ...
    while True:
        ...
        elif item == lst[guess]: return guess
        elif item < lst[guess]: high = guess - 1
        elif item > lst[guess]: low = guess + 1

def update_record(student_records, ID, record_title, data):
    if record_title == "ID":
        return "ID cannot be updated"
    record, lst = {"Email": 1, "Mid1": 2, "Mid2": 3}, [i[0] for i in student_records]
